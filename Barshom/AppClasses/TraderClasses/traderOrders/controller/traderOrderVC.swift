...
class traderOrderVC: UIViewController {
  ...
  func getSection() -> [topSection]{
    ...
    sections.append(topSection(Resources.Common.inProgress))
    sections.append(topSection(Resources.Common.finishedOrdeer))
...
extension traderOrderVC:traderOrderDelegate,reloadDelegate{
...
extension traderOrderVC: DZNEmptyDataSetSource, DZNEmptyDataSetDelegate {
    // ===============================================
